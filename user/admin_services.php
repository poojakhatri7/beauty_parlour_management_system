  ...
  <body>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Adding New Services</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="card card-info">
              ...
              <form class="form-horizontal" action="" method= "post">
                ...
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn" style="background-color: rgb(33, 165, 100); font-weight: 500; font-size: 16px;  padding: 7px 15px; ">Add</button>
