              ...
              <form class="form-horizontal" action="" method= "post">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="mobile_number" class="form-control" id="inputEmail3" placeholder="ENTER MOBILE NUMBER">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text"name="email_us" class="form-control" id="inputEmail3" placeholder="ENTER EMAIL">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">TIME</label>
                    <div class="col-sm-10">
                      <input type="text" name="time" class="form-control" id="inputPassword3" placeholder="ENTER TIME ">
                    </div>
                  </div>
                  <div class="form-group row">
